...
require (
	...
	github.com/netobserv/flowlogs-pipeline v1.9.1-community // indirect
	github.com/netsampler/goflow2 v1.3.7 // indirect
	github.com/ovn-org/ovn-kubernetes/go-controller v0.0.0-20251006150048-ef92f7820852 // indirect
