import { calculateMatrixTotals, Metrics } from '../../../api/loki';
import topologyJson from '../../../../../mocks/loki/topology.json';

export const responseMock = topologyJson;

export const dataMock = (responseMock.data.result as Metrics[]).flatMap(r => calculateMatrixTotals(r, 'sum'));
...
export const dataSample = (responseSample.data.result as Metrics[]).flatMap(r => calculateMatrixTotals(r, 'sum'));
