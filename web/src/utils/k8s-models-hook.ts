...
export function useK8sModelsWithColors() {
  ...
  if (k8sModels && !inFlight) {
     ...
     */
    //$color-application-dark = $pf-v6-color-green-500 = #3E8635
    setColor('Application', '#3E8635');

    //$color-rbac-role-dark = $pf-v6-color-gold-600 = #795600
    setColor('ClusterRole', '#795600');
    setColor('Role', '#795600');

    //$color-rbac-binding-dark = $pf-v6-color-light-blue-500 = #008BAD
    setColor('ClusterRoleBinding', '#008BAD');
    setColor('RoleBinding', '#008BAD');

    //$color-pod-overlord = $pf-v6-color-blue-500 = #004080
    ...
    //$color-node-dark = $pf-v6-color-purple-400 = #8476D1
    ...
    //$color-configmap-dark = $pf-v6-color-purple-600 = #40199A
    ...
    //$color-container-dark = $pf-v6-color-blue-300 = #2B9AF3
    setColor('Alert', '#2B9AF3');
    setColor('Container', '#2B9AF3');

    //$color-pod-dark = $pf-v6-color-cyan-300 = #009596
    setColor('Pod', '#009596');

    //$color-namespace-dark = $pf-v6-color-green-600 = #1E4F18
    setColor('Namespace', '#1E4F18');
    setColor('Project', '#1E4F18');

    //$color-secret-dark = $pf-v6-color-orange-400 = #C46100
    setColor('Secret', '#C46100');

    //$color-alertmanager-dark = $pf-v6-color-orange-600 = #773D00
    setColor('AlertManager', '#773D00');

    //$color-service-dark = $pf-v6-color-light-green-500 = #3E8635
    setColor('Service', '#3E8635');

    //$color-ingress-dark = $pf-v6-color-purple-700 = #1F0066
